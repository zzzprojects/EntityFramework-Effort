...
{
    public class MMDBWrapperTransaction : DbTransaction
    {
        private MMDBWrapperConnection connection;
        private System.Data.IsolationLevel isolationLevel;

        private System.Transactions.CommittableTransaction transaction;

        public MMDBWrapperTransaction(MMDBWrapperConnection connection, System.Data.IsolationLevel isolationLevel) 
        {
