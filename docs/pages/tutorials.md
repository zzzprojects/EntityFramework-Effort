...
<div class="row">
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning about how to use Entity Framework Effort with our getting started tutorial.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning the common API of Entity Framework Effort, and everything around it.</p>
			<p class="lead">
