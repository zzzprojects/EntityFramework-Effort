...
namespace EFProviderWrapperToolkit
{
    ...
    {
        internal static string WrappedProviderKey = "wrappedProvider=";
        ...
        public override string ConnectionString
        {
            get
            {
                return WrappedProviderKey + this.wrappedProviderInvariantName + ";" + this.wrappedConnection.ConnectionString;
            }
        ...
        private void CreateConnectionFromConnectionString(string connectionString)
        {
            ...
            int pos = connectionString.IndexOf(WrappedProviderKey, StringComparison.OrdinalIgnoreCase);
            if (pos == 0)
            {
                ...
                providerInvariantName = connectionString.Substring(WrappedProviderKey.Length, pos2 - WrappedProviderKey.Length);
