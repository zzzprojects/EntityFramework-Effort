// --------------------------------------------------------------------------------------------
// <copyright file="DbConnectionWrapper.cs" company="Microsoft">
...
namespace Effort.Test.Internal.WrapperProviders
{
    ...
    /// </summary>
    internal abstract class DbConnectionWrapper : DbConnection
    {
...
#if !NET40
        /// <summary>
        /// This is the asynchronous version of <see cref="M:System.Data.Common.DbConnection.Open" />. 
        /// </summary>
        ...
        public override Task OpenAsync(CancellationToken cancellationToken)
        {
            ...
            return this.wrappedConnection.OpenAsync(cancellationToken);
        }
#endif
